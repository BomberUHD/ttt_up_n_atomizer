...
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "10% less vertical recoil", "10% less horizontal recoil", "5% less spread", TFA.AttachmentColors["-"], "5% less mobility" }
ATTACHMENT.Icon = "entities/comp_1.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
