...
ATTACHMENT.Name = "Heavy Duty Muzzle Brake"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "10% less vertical recoil", "10% less horizontal recoil", "5% less spread" }
ATTACHMENT.Icon = "entities/muzz_5.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
