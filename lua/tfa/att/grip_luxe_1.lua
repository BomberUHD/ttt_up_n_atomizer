...
ATTACHMENT.Name = "Luxurious Grip"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "10% less vertical recoil", "10% less horizontal recoil", "5% less spread", "Sleek black with a golden etched pattern", TFA.AttachmentColors["-"], "5% less mobility" }
ATTACHMENT.Icon = "entities/grip_luxe_1.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
	...
	["SprintAnimation"] = {
		["loop"] = function(wep,val)
			...
			if val.value_empty then
				val["value_empty"] = "grip_sprint_empty"
			end
