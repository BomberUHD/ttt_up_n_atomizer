...
ATTACHMENT.Icon = "entities/mpi_drum.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
ATTACHMENT.WeaponTable = {
	...
	["Primary"] = {
		["ClipSize"] = function(wep,stat) return stat + 18 end
	},
	["Animations"] = {
		["reload"] = {
