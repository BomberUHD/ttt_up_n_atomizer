...
ATTACHMENT.Icon = "entities/snsmk2_ex.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
...
ATTACHMENT.WeaponTable = {
	...
	["Primary"] = {
		["ClipSize"] = function(wep,stat) return stat + 6 end
	},
	["Animations"] = {
		["reload"] = {
