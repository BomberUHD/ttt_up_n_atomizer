...
function ATTACHMENT:Attach( wep )
	wep.VElements["scope_large_2x"].skin_old = wep.VElements["scope_large_2x"].skin_old or wep.VElements["scope_large_2x"].skin
	wep.VElements["scope_large_2x"].skin = self.WeaponTable.Skin
	wep.WElements["scope_large_2x"].skin_old = wep.VElements["scope_large_2x"].skin_old or wep.VElements["scope_large_2x"].skin
	wep.WElements["scope_large_2x"].skin = self.WeaponTable.Skin
...
function ATTACHMENT:Detach( wep )
	wep.VElements["scope_large_2x"].skin = wep.VElements["scope_large_2x"].skin_old
	wep.WElements["scope_large_2x"].skin = wep.VElements["scope_large_2x"].skin_old
