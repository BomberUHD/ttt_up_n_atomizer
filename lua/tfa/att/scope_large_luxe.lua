...
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "5% less spread", TFA.AttachmentColors["+"], "Elegant golden etched patterns", TFA.AttachmentColors["="], "3x zoom", TFA.AttachmentColors["-"], "25% higher zoom time",  TFA.AttachmentColors["-"], "Obstructed field of view" }
...
local fov = 90 / 3 / 2 -- Default FOV / Scope Zoom / screenscale
...
ATTACHMENT.WeaponTable = {
	...
	["Secondary"] = {
		...
		["ScopeZoom"] = function( wep, val ) return 30 end
	},
